...
import com.tmn.account.service.impl.AccountRepository;
import com.tmn.account.service.impl.UserRepository;
...
//        String nextJSP = "/mainPanel.jsp";
        ...
        if(loggingInUser==null || !loggingInUser.getPassword().equals(password)){ 
            ...
            logger.debug("find account by name : "+loggingInUser.getUsername());    
            AccountRepository accountRepository = new AccountRepository();
            Account account = accountRepository.getAccountByName(loggingInUser.getUsername());
            session.setAttribute("account", account);
            logger.debug("set session account");    
        }
